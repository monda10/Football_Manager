...
namespace Real_Madrid_Soccer
{
    public partial class Form1 : Form
    {
        ...
        private void LegendButton2_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.realmadrid.com/en/about-real-madrid/history/football-legends");
        }
        // 선수 경력 및 수상 및 커리어
